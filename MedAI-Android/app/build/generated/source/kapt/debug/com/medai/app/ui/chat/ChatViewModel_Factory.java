...
public final class ChatViewModel_Factory implements Factory<ChatViewModel> {
  ...
  public static ChatViewModel_Factory create(Provider<ChatRepository> repoProvider,
      Provider<PrefsManager> prefsProvider) {
    return new ChatViewModel_Factory(repoProvider, prefsProvider);
  }

  public static ChatViewModel newInstance(ChatRepository repo, PrefsManager prefs) {
    return new ChatViewModel(repo, prefs);
  }
}
