...
public final class ItemConversationBinding implements ViewBinding {
  ...
  private ItemConversationBinding(@NonNull LinearLayout rootView, @NonNull TextView tvTitle) {
  ...
  public static ItemConversationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemConversationBinding((LinearLayout) rootView, tvTitle);
    }
